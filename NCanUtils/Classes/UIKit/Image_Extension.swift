...
public extension UIImage {
    ...
    /// NCanUtils: Size in bytes of UIImage
    var bytesSize: Int {
        return jpegData(compressionQuality: 1)?.count ?? 0
    }

    /// NCanUtils: Size in kilo bytes of UIImage
    var kilobytesSize: Int {
        return (jpegData(compressionQuality: 1)?.count ?? 0) / 1024
    }

    /// NCanUtils: UIImage with .alwaysOriginal rendering mode.
    var original: UIImage {
        return withRenderingMode(.alwaysOriginal)
    }

    /// NCanUtils: UIImage with .alwaysTemplate rendering mode.
...
public extension UIImage {
    ...
    /// NCanUtils: Compressed UIImage from original UIImage.
    ///
    ...
    /// NCanUtils: Compressed UIImage data from original UIImage.
    ///
    /// - Parameter quality: The quality of the resulting JPEG image, expressed as a value from 0.0 to 1.0. The value 0.0 represents the maximum compression (or lowest quality) while the value 1.0 represents the least compression (or best quality), (default is 0.5).
    ...
    /// NCanUtils: UIImage Cropped to CGRect.
    ///
    ...
    /// NCanUtils: UIImage Cropped to transparent around space.
    ///
    /// - Returns: cropped UIImage
    ...
    /// NCanUtils: UIImage scaled to height with respect to aspect ratio.
    ///
    /// - Parameters:
    ///   - toHeight: new height.
    ...
    /// NCanUtils: UIImage scaled to width with respect to aspect ratio.
    ///
    /// - Parameters:
    ///   - toWidth: new width.
    ///   - opaque: flag indicating whether the bitmap is opaque.
    ...
    /// NCanUtils: Creates a copy of the receiver rotated by the given angle.
    ///
    ...
    /// NCanUtils: Creates a copy of the receiver rotated by the given angle (in radians).
    ///
    ///     // Rotate the image by 180°
    ///     image.rotated(by: .pi)
    ///
    ...
    /// NCanUtils: UIImage filled with color
    ///
    ...
    /// NCanUtils: UIImage tinted with color
    ///
    /// - Parameters:
    ...
    /// NCanUtils: UIImage with rounded corners
    ///
    /// - Parameters:
    ...
    /// NCanUtils: Base 64 encoded PNG data of the image.
    ///
    ...
    /// NCanUtils: Base 64 encoded JPEG data of the image.
    ///
...
public extension UIImage {
    ...
    /// NCanUtils: Create UIImage from color and size.
    ///
    /// - Parameters:
    ...
    /// NCanUtils: Create a new image from a base 64 string.
    ///
    /// - Parameters:
    ...
    /// NCanUtils: Create a new image from a URL
    ///
    /// - Important:
