...
public extension Date {
    ...
    enum DayNameStyle {
        ...
        /// NCanUtils: 3 letter day abbreviation of day name.
        case threeLetters

        /// NCanUtils: 1 letter day abbreviation of day name.
        case oneLetter

        /// NCanUtils: Full day name.
        case full

    }

    /// NCanUtils: Month name format.
    ///
    ...
    enum MonthNameStyle {
        ...
        /// NCanUtils: 3 letter month abbreviation of month name.
        case threeLetters

        /// NCanUtils: 1 letter month abbreviation of month name.
        case oneLetter

        /// NCanUtils: Full month name.
        case full
...
public extension Date {
    ...
    /// NCanUtils: User’s current calendar.
    ...
    /// NCanUtils: Check if date is in future.
    ///
    ...
    /// NCanUtils: Check if date is in past.
    ///
    ...
    /// NCanUtils: Check if date is within today.
    ///
    ///     Date().isInToday -> true
    ///
    var isInToday: Bool {
    ...
    /// NCanUtils: Check if date is within yesterday.
    ///
    ...
    /// NCanUtils: Check if date is within tomorrow.
    ///
    ...
    /// NCanUtils: Check if date is within a weekend period.
    var isInWeekend: Bool {
        return calendar.isDateInWeekend(self)
    }

    /// NCanUtils: Check if date is within a weekday period.
    var isWorkday: Bool {
        return !calendar.isDateInWeekend(self)
    }

    /// NCanUtils: Check if date is within the current week.
    var isInCurrentWeek: Bool {
        return calendar.isDate(self, equalTo: Date(), toGranularity: .weekOfYear)
    }

    /// NCanUtils: Check if date is within the current month.
    var isInCurrentMonth: Bool {
        return calendar.isDate(self, equalTo: Date(), toGranularity: .month)
    }

    /// NCanUtils: Check if date is within the current year.
    var isInCurrentYear: Bool {
        return calendar.isDate(self, equalTo: Date(), toGranularity: .year)
    }

    /// NCanUtils: ISO8601 string of format (yyyy-MM-dd'T'HH:mm:ss.SSS) from date.
    ///
    ...
    /// NCanUtils: Nearest five minutes to date.
    ///
    ...
    /// NCanUtils: Nearest ten minutes to date.
    ///
    ...
    /// NCanUtils: Nearest quarter hour to date.
    ///
    ///     var date = Date() // "5:57 PM"
    ///     date.minute = 34 // "5:34 PM"
    ...
    /// NCanUtils: Nearest half hour to date.
    ///
    ...
    /// NCanUtils: Nearest hour to date.
    ///
    ...
    /// NCanUtils: UNIX timestamp from date.
    ///
...
public extension Date {
    ...
    /// NCanUtils: Date by adding multiples of calendar component.
    ///
    ...
    /// NCanUtils: Add calendar component to date.
    ///
    ...
    /// NCanUtils: Date by changing value of calendar component.
    ///
    ///     let date = Date() // "Jan 12, 2017, 7:07 PM"
    ...
    /// NCanUtils: Date at the end of calendar component.
    ///
    ...
    /// NCanUtils: Check if date is in current given calendar component.
    ///
    ...
    /// NCanUtils: Date string from date.
    ///
    ...
    /// NCanUtils: Date and time string from date.
    ///
    ...
    /// NCanUtils: Time string from date
    ///
    ...
    /// NCanUtils: Month name from date.
    ///
    ...
    /// NCanUtils: get number of seconds between two date
    ///
    ...
    /// NCanUtils: get number of minutes between two date
    ///
    /// - Parameter date: date to compate self to.
    ...
    /// NCanUtils: get number of hours between two date
    ///
    /// - Parameter date: date to compate self to.
    ...
    /// NCanUtils: get number of days between two date
    ///
    /// - Parameter date: date to compate self to.
    ...
    /// NCanUtils: check if a date is between two other dates
    ///
    /// - Parameters:
    ...
    /// NCanUtils: check if a date is a number of date components of another date
    ///
    /// - Parameters:
...
public extension Date {
    ...
    /// NCanUtils: Returns a random date within the specified range, using the given generator as a source for randomness.
    ///
    /// - Parameters:
...
public extension Date {
    ...
    /// NCanUtils: Create a new date form calendar components.
    ///
    ...
    /// NCanUtils: Create date object from ISO8601 string.
    ///
    ...
    /// NCanUtils: Create new date object from UNIX timestamp.
    ///
    ...
    /// NCanUtils: Create date object from Int literal
    ///
